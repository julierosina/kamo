...
git branch -M main
git remote add origin https://github.com/TON_USERNAME/kamo.git
git push -u origin main
```

### 3. Mettre à jour le homepage dans package.json

Ouvre `package.json` et remplace `YOUR_USERNAME` par ton vrai nom d'utilisateur GitHub :

```json
"homepage": "https://TON_USERNAME.github.io/kamo"
```
...
C'est tout. Ton site sera live sur `https://TON_USERNAME.github.io/kamo` dans ~2 minutes.
